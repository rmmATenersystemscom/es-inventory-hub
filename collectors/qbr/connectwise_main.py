...
from .connectwise_collector import ConnectWiseQBRCollector
from .utils import get_current_period, get_last_n_periods


def main():
    """Main CLI entry point for ConnectWise QBR collector."""
    parser = argparse.ArgumentParser(description='ConnectWise QBR metric collector')
    parser.add_argument(
        '--period',
        type=str,
    ...
    collector = ConnectWiseQBRCollector(organization_id=args.organization_id)
